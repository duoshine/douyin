...
public class CTabLayout extends HorizontalScrollView {
  ...
  /**
   * Gravity used to fill the {@link CTabLayout} as much as possible. This option only takes effect
  ...
  /**
   * Gravity used to lay out the tabs in the center of the {@link CTabLayout}.
   *
   * @see #setTabGravity(int)
   * @see #getTabGravity()
   */
  ...
  /**
   * Gravity used to lay out the tabs aligned to the start of the {@link CTabLayout}.
   *
   * @see #setTabGravity(int)
   * @see #getTabGravity()
   */
   ...
   * CTabLayout}. This will only take effect if the indicator height is set via the custom indicator
   ...
   * width of the {@link CTabLayout}. This will disregard {@code tabIndicatorHeight} and the
  ...
  public CTabLayout(@NonNull Context context) {
    this(context, null);
  }

  public CTabLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
    this(context, attrs, R.attr.tabStyle);
  }

  @SuppressLint("RestrictedApi")
  public CTabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
  ...
  /**
   * Add a {@link CTabLayout.OnTabSelectedListener} that will be invoked when tab selection changes.
   *
  ...
  /**
   * Add a {@link CTabLayout.BaseOnTabSelectedListener} that will be invoked when tab selection
   * changes.
   *
   * <p>Components that add a listener should take care to remove it when finished via {@link
  ...
  /**
   * Remove the given {@link CTabLayout.OnTabSelectedListener} that was previously added via {@link
  ...
  /**
   * Remove the given {@link CTabLayout.BaseOnTabSelectedListener} that was previously added via
  ...
  /** Remove all previously added {@link CTabLayout.OnTabSelectedListener}s. */
  ...
  /**
   * Returns the current mode used by this {@link CTabLayout}.
   *
   * @see #setTabMode(int)
   */
  @Mode
  ...
  /**
   * Set the indicator gravity used to align the tab selection indicator in the {@link CTabLayout}.
   ...
   * indicator height and stretch across the entire height and width of the {@link CTabLayout}. This
  ...
  /**
   * Set whether this {@link CTabLayout} will have an unbounded ripple effect or if ripple will be
  ...
  /**
   * Returns whether this {@link CTabLayout} has an unbounded ripple effect, or if ripple is bound to
   * the tab item size.
   *
  ...
  /**
   * The one-stop shop for setting up this {@link CTabLayout} with a {@link ViewPager}.
   *
  ...
  public static class Tab {
    ...
    @Nullable public CTabLayout parent;
    // TODO(b/76413401): make package private after the widget migration is finished
  ...
  /** A {@link LinearLayout} containing {@link Tab} instances for use with {@link CTabLayout}. */
  public final class TabView extends LinearLayout {
    ...
    protected void drawableStateChanged() {
      ...
      if (changed) {
        invalidate();
        CTabLayout.this.invalidate(); // Invalidate TabLayout, which draws mBaseBackgroundDrawable
      }
    }
   ...
   * provided {@link CTabLayout} so that the tab position is kept in sync.
   *
  ...
  public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
    @NonNull private final WeakReference<CTabLayout> tabLayoutRef;
    private int previousScrollState;
    private int scrollState;

    public TabLayoutOnPageChangeListener(CTabLayout tabLayout) {
    ...
    public void onPageScrolled(
      ...
      final CTabLayout tabLayout = tabLayoutRef.get();
      if (tabLayout != null) {
  ...
  /**
   * A {@link CTabLayout.OnTabSelectedListener} class which contains the necessary calls back to the
   * provided {@link ViewPager} so that the tab position is kept in sync.
   */
  public static class ViewPagerOnTabSelectedListener implements CTabLayout.OnTabSelectedListener {
    ...
    @Override
    public void onTabSelected(@NonNull CTabLayout.Tab tab) {
      viewPager.setCurrentItem(tab.getPosition());
    }

    @Override
    public void onTabUnselected(CTabLayout.Tab tab) {
      // No-op
    }

    @Override
    public void onTabReselected(CTabLayout.Tab tab) {
      // No-op
    }
  }
  ...
  private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
    ...
    public void onAdapterChanged(
      ...
      if (CTabLayout.this.viewPager == viewPager) {
