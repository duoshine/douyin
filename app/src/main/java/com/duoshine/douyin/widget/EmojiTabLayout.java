 ...
 */
@ViewPager.DecorView
public class EmojiTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link EmojiTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link EmojiTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    /**
     * Gravity used to lay out the tabs aligned to the start of the {@link EmojiTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
     ...
     * EmojiTabLayout}. This will only take effect if the indicator height is set via the custom indicator
     ...
     * width of the {@link EmojiTabLayout}. This will disregard {@code tabIndicatorHeight} and the
    ...
    public EmojiTabLayout(@NonNull Context context) {
        this(context, null);
    }

    public EmojiTabLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.tabStyle);
    }

    @SuppressLint("RestrictedApi")
    public EmojiTabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * Add a {@link EmojiTabLayout.OnTabSelectedListener} that will be invoked when tab selection changes.
     *
    ...
    /**
     * Add a {@link EmojiTabLayout.BaseOnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
     * <p>Components that add a listener should take care to remove it when finished via {@link
    ...
    /**
     * Remove the given {@link EmojiTabLayout.OnTabSelectedListener} that was previously added via {@link
    ...
    /**
     * Remove the given {@link EmojiTabLayout.BaseOnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link EmojiTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Returns the current mode used by this {@link EmojiTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * Set the indicator gravity used to align the tab selection indicator in the {@link EmojiTabLayout}.
     ...
     * indicator height and stretch across the entire height and width of the {@link EmojiTabLayout}. This
    ...
    /**
     * Set whether this {@link EmojiTabLayout} will have an unbounded ripple effect or if ripple will be
    ...
    /**
     * Returns whether this {@link EmojiTabLayout} has an unbounded ripple effect, or if ripple is bound to
     * the tab item size.
     *
     * @attr ref com.google.android.material.R.styleable#TabLayout_tabUnboundedRipple
    ...
    /**
     * Sets the selection indicator for this TabLayout. By default, this is a seekbar_hide_line along the bottom of
     ...
     * this is a seekbar_hide_line along the bottom of the tab. If {@code tabIndicatorColor} is specified via the
    ...
    /**
     * The one-stop shop for setting up this {@link EmojiTabLayout} with a {@link ViewPager}.
     *
    ...
    /**
     * A {@link LinearLayout} containing {@link Tab} instances for use with {@link EmojiTabLayout}.
     */
    public final class TabView extends LinearLayout {
        ...
        public TabView(@NonNull Context context) {
            ...
            // todo  让tabLayout item不具备padding值
      /*      ViewCompat.setPaddingRelative(
            ...
            setClickable(false); //todo  设置不允许点击
        ...
        private void updateBackgroundDrawable(Context context) {
            ...
            EmojiTabLayout.this.invalidate();
        }
        ...
        protected void drawableStateChanged() {
            ...
            if (changed) {
                invalidate();
                EmojiTabLayout.this.invalidate(); // Invalidate TabLayout, which draws mBaseBackgroundDrawable
            }
        }
        ...
        public void onMeasure(final int origWidthMeasureSpec, final int origHeightMeasureSpec) {
            ...
            if (textView != null) {
                ...
                if (iconView != null && iconView.getVisibility() == VISIBLE) {
                    // If the icon view is being displayed, we limit the text to 1 seekbar_hide_line
                    maxLines = 1;
                ...
                if (textSize != curTextSize || (curMaxLines >= 0 && maxLines != curMaxLines)) {
                    ...
                    if (mode == MODE_FIXED && textSize > curTextSize && curLineCount == 1) {
                        // If we're in fixed mode, going up in text size and currently have 1 seekbar_hide_line
                        // then it's very easy to get into an infinite recursion.
                        // To combat that we check to see if the change in text size
                        // will cause a seekbar_hide_line count change. If so, abort the size change and stick
                        // to the smaller size.
            ...
            if (indicatorLeft >= 0 && indicatorRight > indicatorLeft) {
                ...
                selectedIndicator =
                        DrawableCompat.wrap(
                                ...
                                .mutate();
                selectedIndicator.setBounds(indicatorLeft + 14, indicatorTop, indicatorRight - 14, indicatorBottom);
     ...
     * provided {@link EmojiTabLayout} so that the tab position is kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        @NonNull
        private final WeakReference<EmojiTabLayout> tabLayoutRef;
        private int previousScrollState;
        private int scrollState;

        public TabLayoutOnPageChangeListener(EmojiTabLayout tabLayout) {
        ...
        public void onPageScrolled(
            ...
            final EmojiTabLayout tabLayout = tabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link EmojiTabLayout.OnTabSelectedListener} class which contains the necessary calls back to the
     * provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements EmojiTabLayout.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(@NonNull EmojiTabLayout.Tab tab) {
            viewPager.setCurrentItem(tab.getPosition());
        }

        @Override
        public void onTabUnselected(EmojiTabLayout.Tab tab) {
            // No-op
        }

        @Override
        public void onTabReselected(EmojiTabLayout.Tab tab) {
            // No-op
        }
    }
    ...
    private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
        ...
        public void onAdapterChanged(
            ...
            if (EmojiTabLayout.this.viewPager == viewPager) {
