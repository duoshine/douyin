...
import com.duoshine.douyin.meishe.sdkdemo.base.BaseFragmentPagerAdapter;
import com.duoshine.douyin.meishe.sdkdemo.edit.EditBaseActivity;
...
import static com.duoshine.douyin.meishe.sdkdemo.edit.watermark.WaterMarkConstant.WATERMARKTYPE_DYNAMICS;
import static com.duoshine.douyin.meishe.sdkdemo.edit.watermark.WaterMarkConstant.WATERMARKTYPE_STATIC;
import static com.duoshine.douyin.meishe.sdkdemo.utils.MediaConstant.SINGLE_PICTURE_PATH;
...
public class WaterMarkActivity extends EditBaseActivity implements OnItemClickListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            TimelineUtil.checkAndDeleteExitFX(nvsTimeline);
            setActivityData(WATERMARKTYPE_STATIC, data.getStringExtra(SINGLE_PICTURE_PATH), data.getStringExtra(SINGLE_PICTURE_PATH));
            setWaterMarkOnTheFirst(mWaterMarkPicture);
            refreshLiveWindowFrame();
            WaterMarkSelectFragment waterMarkSelectFragment = (WaterMarkSelectFragment) fragmentLists.get(0);
