...
import com.duoshine.douyin.meishe.sdkdemo.edit.Caption.CaptionFontRecyclerAdaper;
import com.duoshine.douyin.meishe.sdkdemo.edit.CompileVideoFragment;
...
import static com.duoshine.douyin.meishe.sdkdemo.utils.Constants.ASSET_DOWNLOAD_FAILED;
import static com.duoshine.douyin.meishe.sdkdemo.utils.Constants.ASSET_DOWNLOAD_INPROGRESS;
import static com.duoshine.douyin.meishe.sdkdemo.utils.Constants.ASSET_DOWNLOAD_START_TIMER;
import static com.duoshine.douyin.meishe.sdkdemo.utils.Constants.ASSET_DOWNLOAD_SUCCESS;
import static com.duoshine.douyin.meishe.sdkdemo.utils.Constants.ASSET_LIST_REQUEST_FAILED;
import static com.duoshine.douyin.meishe.sdkdemo.utils.Constants.ASSET_LIST_REQUEST_SUCCESS;
import static com.duoshine.douyin.meishe.sdkdemo.utils.Constants.CaptionColors;
    ...
    private void loadVideoClipFailTips(){
        ...
        * */
        if(mTimeline == null || (mTimeline != null && mTimeline.getDuration() <= 0 )){
            ...
            Util.showDialog(FlipCaptionActivity.this, versionName[0], versionName[1], new CommonDialog.TipsButtonClickListener() {
                @Override
