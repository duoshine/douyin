...
import com.duoshine.douyin.meishe.sdkdemo.edit.Caption.CaptionActivity;
...
import com.duoshine.douyin.meishe.sdkdemo.edit.anim.AnimationActivity;
import com.duoshine.douyin.meishe.sdkdemo.edit.animatesticker.AnimateStickerActivity;
import com.duoshine.douyin.meishe.sdkdemo.edit.clipEdit.EditActivity;
import com.duoshine.douyin.meishe.sdkdemo.edit.compoundcaption.CompoundCaptionActivity;
...
import com.duoshine.douyin.meishe.sdkdemo.edit.data.BitmapData;
import com.duoshine.douyin.meishe.sdkdemo.edit.filter.FilterActivity;
...
import com.duoshine.douyin.meishe.sdkdemo.edit.music.MusicActivity;
import com.duoshine.douyin.meishe.sdkdemo.edit.record.RecordActivity;
import com.duoshine.douyin.meishe.sdkdemo.edit.theme.ThemeActivity;
import com.duoshine.douyin.meishe.sdkdemo.edit.transition.TransitionActivity;
...
import com.duoshine.douyin.meishe.sdkdemo.edit.watermark.WaterMarkActivity;
...
import static com.duoshine.douyin.meishe.sdkdemo.utils.Constants.VIDEOVOLUME_MAXSEEKBAR_VALUE;
import static com.duoshine.douyin.meishe.sdkdemo.utils.Constants.VIDEOVOLUME_MAXVOLUMEVALUE;
    ...
    private void loadVideoClipFailTips() {
        ...
        * */
        if (mTimeline == null || (mTimeline.getDuration() <= 0)) {
            ...
            Util.showDialog(VideoEditActivity.this, versionName[0], versionName[1], new CommonDialog.TipsButtonClickListener() {
                @Override
